...
-- 119 partners, 1034 rows, total: 15,236,524,256
...
-- 773: 6 cuotas, total 150,000,000
INSERT INTO planes_pago (periodo, monto_proyectado, socio_id) VALUES
  ('2025-11', 39000000, (SELECT id FROM socios WHERE certificado_no = 773)),
...
-- 80: 4 cuotas, total 75,000,000
INSERT INTO planes_pago (periodo, monto_proyectado, socio_id) VALUES
  ('2025-11', 25000000, (SELECT id FROM socios WHERE certificado_no = 80)),
...
-- 92: 4 cuotas, total 75,000,000
INSERT INTO planes_pago (periodo, monto_proyectado, socio_id) VALUES
  ('2025-11', 33750000, (SELECT id FROM socios WHERE certificado_no = 92)),
...
-- 40: 5 cuotas, total 150,000,000
INSERT INTO planes_pago (periodo, monto_proyectado, socio_id) VALUES
  ('2025-11', 40000000, (SELECT id FROM socios WHERE certificado_no = 40)),
...
-- 245: 10 cuotas, total 187,500,000
INSERT INTO planes_pago (periodo, monto_proyectado, socio_id) VALUES
  ('2025-11', 60000000, (SELECT id FROM socios WHERE certificado_no = 245)),
...
-- 302: 12 cuotas, total 150,000,000
INSERT INTO planes_pago (periodo, monto_proyectado, socio_id) VALUES
  ('2025-11', 30000000, (SELECT id FROM socios WHERE certificado_no = 302)),
...
-- 112: 8 cuotas, total 187,500,000
INSERT INTO planes_pago (periodo, monto_proyectado, socio_id) VALUES
  ('2025-11', 40000000, (SELECT id FROM socios WHERE certificado_no = 112)),
...
-- 159: 10 cuotas, total 112,500,000
INSERT INTO planes_pago (periodo, monto_proyectado, socio_id) VALUES
  ('2025-11', 38250000, (SELECT id FROM socios WHERE certificado_no = 159)),
...
-- 365: 2 cuotas, total 67,500,000
INSERT INTO planes_pago (periodo, monto_proyectado, socio_id) VALUES
  ('2025-11', 45000000, (SELECT id FROM socios WHERE certificado_no = 365)),
  ('2025-12', 22500000, (SELECT id FROM socios WHERE certificado_no = 365));

-- 45: 2 cuotas, total 75,000,000
INSERT INTO planes_pago (periodo, monto_proyectado, socio_id) VALUES
  ('2025-11', 45000000, (SELECT id FROM socios WHERE certificado_no = 45)),
  ('2025-12', 30000000, (SELECT id FROM socios WHERE certificado_no = 45));

-- 143: 4 cuotas, total 75,000,000
INSERT INTO planes_pago (periodo, monto_proyectado, socio_id) VALUES
  ('2025-11', 20000000, (SELECT id FROM socios WHERE certificado_no = 143)),
...
-- 192: 14 cuotas, total 150,000,000
INSERT INTO planes_pago (periodo, monto_proyectado, socio_id) VALUES
  ('2025-11', 20000000, (SELECT id FROM socios WHERE certificado_no = 192)),
...
-- 70: 6 cuotas, total 75,000,000
INSERT INTO planes_pago (periodo, monto_proyectado, socio_id) VALUES
  ('2025-11', 20000000, (SELECT id FROM socios WHERE certificado_no = 70)),
...
-- 249: 12 cuotas, total 150,000,000
INSERT INTO planes_pago (periodo, monto_proyectado, socio_id) VALUES
  ('2025-11', 30800000, (SELECT id FROM socios WHERE certificado_no = 249)),
...
-- 56: 5 cuotas, total 150,000,000
INSERT INTO planes_pago (periodo, monto_proyectado, socio_id) VALUES
  ('2025-11', 40000000, (SELECT id FROM socios WHERE certificado_no = 56)),
...
-- 47: 4 cuotas, total 150,000,000
INSERT INTO planes_pago (periodo, monto_proyectado, socio_id) VALUES
  ('2025-11', 50000000, (SELECT id FROM socios WHERE certificado_no = 47)),
...
-- 202: 7 cuotas, total 150,000,000
INSERT INTO planes_pago (periodo, monto_proyectado, socio_id) VALUES
  ('2025-11', 20000000, (SELECT id FROM socios WHERE certificado_no = 202)),
...
-- 723: 2 cuotas, total 75,000,000
INSERT INTO planes_pago (periodo, monto_proyectado, socio_id) VALUES
  ('2025-11', 45000000, (SELECT id FROM socios WHERE certificado_no = 723)),
  ('2025-12', 30000000, (SELECT id FROM socios WHERE certificado_no = 723));

-- 61: 11 cuotas, total 120,000,000
INSERT INTO planes_pago (periodo, monto_proyectado, socio_id) VALUES
  ('2025-11', 28000000, (SELECT id FROM socios WHERE certificado_no = 61)),
...
-- 575: 2 cuotas, total 75,000,000
INSERT INTO planes_pago (periodo, monto_proyectado, socio_id) VALUES
  ('2025-11', 45000000, (SELECT id FROM socios WHERE certificado_no = 575)),
  ('2025-12', 30000000, (SELECT id FROM socios WHERE certificado_no = 575));

-- 610: 6 cuotas, total 150,000,000
INSERT INTO planes_pago (periodo, monto_proyectado, socio_id) VALUES
  ('2025-11', 40000000, (SELECT id FROM socios WHERE certificado_no = 610)),
...
-- 306: 25 cuotas, total 247,500,000
INSERT INTO planes_pago (periodo, monto_proyectado, socio_id) VALUES
  ('2025-11', 24750000, (SELECT id FROM socios WHERE certificado_no = 306)),
...
-- 297: 25 cuotas, total 247,500,000
INSERT INTO planes_pago (periodo, monto_proyectado, socio_id) VALUES
  ('2025-11', 24750000, (SELECT id FROM socios WHERE certificado_no = 297)),
...
-- 309: 24 cuotas, total 240,000,000
INSERT INTO planes_pago (periodo, monto_proyectado, socio_id) VALUES
  ('2025-11', 42000000, (SELECT id FROM socios WHERE certificado_no = 309)),
...
-- 242: 2 cuotas, total 75,000,000
INSERT INTO planes_pago (periodo, monto_proyectado, socio_id) VALUES
  ('2025-11', 45000000, (SELECT id FROM socios WHERE certificado_no = 242)),
...
-- 21: 25 cuotas, total 75,000,000
INSERT INTO planes_pago (periodo, monto_proyectado, socio_id) VALUES
  ('2025-11', 20000000, (SELECT id FROM socios WHERE certificado_no = 21)),
...
-- 222: 2 cuotas, total 75,000,000
INSERT INTO planes_pago (periodo, monto_proyectado, socio_id) VALUES
  ('2025-11', 45000000, (SELECT id FROM socios WHERE certificado_no = 222)),
  ('2025-12', 30000000, (SELECT id FROM socios WHERE certificado_no = 222));

-- 167: 3 cuotas, total 150,000,000
INSERT INTO planes_pago (periodo, monto_proyectado, socio_id) VALUES
  ('2025-11', 40000000, (SELECT id FROM socios WHERE certificado_no = 167)),
...
-- 427: 4 cuotas, total 120,000,000
INSERT INTO planes_pago (periodo, monto_proyectado, socio_id) VALUES
  ('2025-11', 45000000, (SELECT id FROM socios WHERE certificado_no = 427)),
...
-- 366: 7 cuotas, total 112,500,000
INSERT INTO planes_pago (periodo, monto_proyectado, socio_id) VALUES
  ('2025-11', 20000000, (SELECT id FROM socios WHERE certificado_no = 366)),
...
-- 103: 13 cuotas, total 120,000,000
INSERT INTO planes_pago (periodo, monto_proyectado, socio_id) VALUES
  ('2025-11', 20000000, (SELECT id FROM socios WHERE certificado_no = 103)),
...
-- 822: 11 cuotas, total 150,000,000
INSERT INTO planes_pago (periodo, monto_proyectado, socio_id) VALUES
  ('2025-11', 32000000, (SELECT id FROM socios WHERE certificado_no = 822)),
...
-- 216: 2 cuotas, total 75,000,000
INSERT INTO planes_pago (periodo, monto_proyectado, socio_id) VALUES
  ('2025-11', 45000000, (SELECT id FROM socios WHERE certificado_no = 216)),
  ('2025-12', 30000000, (SELECT id FROM socios WHERE certificado_no = 216));

-- 59: 4 cuotas, total 165,000,000
INSERT INTO planes_pago (periodo, monto_proyectado, socio_id) VALUES
  ('2025-11', 62000000, (SELECT id FROM socios WHERE certificado_no = 59)),
...
-- 197: 4 cuotas, total 150,000,000
INSERT INTO planes_pago (periodo, monto_proyectado, socio_id) VALUES
  ('2025-11', 50000000, (SELECT id FROM socios WHERE certificado_no = 197)),
...
-- 98: 4 cuotas, total 75,000,000
INSERT INTO planes_pago (periodo, monto_proyectado, socio_id) VALUES
  ('2025-11', 20000000, (SELECT id FROM socios WHERE certificado_no = 98)),
...
-- 95: 3 cuotas, total 187,500,000
INSERT INTO planes_pago (periodo, monto_proyectado, socio_id) VALUES
  ('2025-11', 20000000, (SELECT id FROM socios WHERE certificado_no = 95)),
...
-- 329: 2 cuotas, total 187,500,000
INSERT INTO planes_pago (periodo, monto_proyectado, socio_id) VALUES
  ('2025-11', 20000000, (SELECT id FROM socios WHERE certificado_no = 329)),
...
-- 145: 8 cuotas, total 187,500,000
INSERT INTO planes_pago (periodo, monto_proyectado, socio_id) VALUES
  ('2025-11', 20000000, (SELECT id FROM socios WHERE certificado_no = 145)),
...
-- 160: 10 cuotas, total 112,500,000
INSERT INTO planes_pago (periodo, monto_proyectado, socio_id) VALUES
  ('2025-11', 38250000, (SELECT id FROM socios WHERE certificado_no = 160)),
...
-- 184: 4 cuotas, total 120,000,000
INSERT INTO planes_pago (periodo, monto_proyectado, socio_id) VALUES
  ('2025-11', 45000000, (SELECT id FROM socios WHERE certificado_no = 184)),
...
-- 344: 6 cuotas, total 75,000,000
INSERT INTO planes_pago (periodo, monto_proyectado, socio_id) VALUES
  ('2025-11', 20000000, (SELECT id FROM socios WHERE certificado_no = 344)),
...
-- 303: 2 cuotas, total 75,000,000
INSERT INTO planes_pago (periodo, monto_proyectado, socio_id) VALUES
  ('2025-11', 45000000, (SELECT id FROM socios WHERE certificado_no = 303)),
